...
INSERT INTO cotizacion (fecha, accion_id, precio_apertura, minimo_diario, maximo_diario, precio_compra_actual, precio_venta_actual, ultimo_precio_cierre, cantidad_compra_diaria, cantidad_venta_diaria)
VALUES 
(CURDATE(), (SELECT id_accion FROM acciones WHERE ticker = 'AAPL'), 145.00, 140.00, 150.00, 148.00, 149.00, 147.00, 1000, 900),
(CURDATE(), (SELECT id_accion FROM acciones WHERE ticker = 'TSLA'), 750.00, 720.00, 780.00, 760.00, 770.00, 740.00, 2000, 1800),
(CURDATE(), (SELECT id_accion FROM acciones WHERE ticker = 'JPM'), 120.00, 115.00, 125.00, 122.00, 123.00, 119.00, 1500, 1300);
...
INSERT INTO operacion (fecha, precio_operado, cantidad_operada, cotizacion_id, tipo_operacion_id, inversor_id) 
VALUES 
