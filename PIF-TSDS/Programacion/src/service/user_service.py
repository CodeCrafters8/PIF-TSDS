...
class UserService:
    ...
    def verificar_contraseña(self, contraseña, contraseña_encriptada):  # 'contraseña_encriptada' debería estar en bytes
        if isinstance(contraseña_encriptada, str):  # Convierte a bytes si es una cadena de texto
            contraseña_encriptada = contraseña_encriptada.encode('utf-8')
    ...
    def iniciar_sesion(self, email, contraseña):
        ...
        if usuario and self.verificar_contraseña(contraseña, usuario.contraseña):  # Comparación de contraseñas
